<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"C:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\order\pay.html";i:1576580539;s:65:"C:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout.html";i:1575915757;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<div class="cart py-container">
		...
		<div class="checkout py-container  pay">
			<div class="checkout-tit">
				...
				<div class="paymark">
					<span class="fl">请您在提交订单<em class="orange time">10分钟</em>之内完成支付，超时订单会自动取消。订单号：<em><?php echo $order['order_sn']; ?></em></span>
			...
			<div class="checkout-steps">
				...
				<div class="step-cont">
					<ul class="payType">
						...
						<li class="<?php if(($k == 'alipay')): ?>selected<?php endif; ?>"><img src="<?php echo $v['logo']; ?>"></li>
						<?php endforeach; ?>
					</ul>
				...
				<div class="submit sui-text-center">
					<a class="sui-btn btn-danger btn-xlarge" href="paysuccess.html" target="_blank">立即支付</a>
				</div>
				<div class="otherpay">
					<div class="step-tit">
						<h5>其他支付方式</h5>
