<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"C:\phpStudy\PHPTutorial\WWW\pyg\public/../application/home\view\cart\index.html";i:1576323708;s:65:"C:\phpStudy\PHPTutorial\WWW\pyg\application\home\view\layout.html";i:1575915757;}*/ ?>
<!DOCTYPE html>
<html>
						...
						<div class="cart-list">
							<ul class="goods-list yui3-g" cart_id="<?php echo $v['id']; ?>" number="<?php echo $v['number']; ?>">
								<li class="yui3-u-1-24">
									<input type="checkbox" class="row_check" <?php if(($v['is_selected'] == 1)): ?>checked="checked"<?php endif; ?> name="" id="" value="" />
								</li>
